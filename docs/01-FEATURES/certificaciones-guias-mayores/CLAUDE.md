# CLAUDE - 01-FEATURES/certificaciones-guias-mayores

Guia operativa para el feature certificaciones-guias-mayores.

## 1) Alcance

- Dominio: feature
- Feature: certificaciones-guias-mayores
- Ruta docs: docs/01-FEATURES/certificaciones-guias-mayores/
...
4. docs/01-FEATURES/certificaciones-guias-mayores/requirements.md
5. docs/01-FEATURES/certificaciones-guias-mayores/walkthrough-certifications.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/certificaciones-guias-mayores/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/certificaciones-guias-mayores/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/certificaciones-guias-mayores/walkthrough-*.md (si existe)
