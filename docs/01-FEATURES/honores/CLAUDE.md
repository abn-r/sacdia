# CLAUDE - 01-FEATURES/honores

Guia operativa para el feature honores.

## 1) Alcance

- Dominio: feature
- Feature: honores
- Ruta docs: docs/01-FEATURES/honores/
...
4. docs/01-FEATURES/honores/design.md
5. docs/01-FEATURES/honores/walkthrough-honors.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/honores/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/honores/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/honores/walkthrough-*.md (si existe)
