# CLAUDE - 01-FEATURES/gestion-clubs

Guia operativa para el feature gestion-clubs.

## 1) Alcance

- Dominio: feature
- Feature: gestion-clubs
- Ruta docs: docs/01-FEATURES/gestion-clubs/
...
4. docs/01-FEATURES/gestion-clubs/design.md
5. docs/01-FEATURES/gestion-clubs/walkthrough-legal-rep-postreg.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/gestion-clubs/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/gestion-clubs/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/gestion-clubs/walkthrough-*.md (si existe)
