# CLAUDE - 01-FEATURES/clases-progresivas

Guia operativa para el feature clases-progresivas.

## 1) Alcance

- Dominio: feature
- Feature: clases-progresivas
- Ruta docs: docs/01-FEATURES/clases-progresivas/
...
4. docs/01-FEATURES/clases-progresivas/design.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/clases-progresivas/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/clases-progresivas/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/clases-progresivas/walkthrough-*.md (si existe)
