# CLAUDE - 01-FEATURES/example-feature

Guia operativa para el feature example-feature.

## 1) Alcance

- Dominio: feature
- Feature: example-feature
- Ruta docs: docs/01-FEATURES/example-feature/
...
4. docs/01-FEATURES/example-feature/requirements.md
5. docs/01-FEATURES/example-feature/design.md
6. docs/01-FEATURES/example-feature/tasks.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/example-feature/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/example-feature/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/example-feature/walkthrough-*.md (si existe)
