# CLAUDE - 01-FEATURES/gestion-seguros

Guia operativa para el feature gestion-seguros.

## 1) Alcance

- Dominio: feature
- Feature: gestion-seguros
- Ruta docs: docs/01-FEATURES/gestion-seguros/
...
4. docs/01-FEATURES/gestion-seguros/requirements.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/gestion-seguros/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/gestion-seguros/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/gestion-seguros/walkthrough-*.md (si existe)
