# CLAUDE - 01-FEATURES/finanzas

Guia operativa para el feature finanzas.

## 1) Alcance

- Dominio: feature
- Feature: finanzas
- Ruta docs: docs/01-FEATURES/finanzas/
...
4. docs/01-FEATURES/finanzas/design.md
5. docs/01-FEATURES/finanzas/walkthrough-finances.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/finanzas/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/finanzas/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/finanzas/walkthrough-*.md (si existe)
