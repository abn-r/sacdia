# CLAUDE - 01-FEATURES/actividades

Guia operativa para el feature actividades.

## 1) Alcance

- Dominio: feature
- Feature: actividades
- Ruta docs: docs/01-FEATURES/actividades/
...
4. docs/01-FEATURES/actividades/design.md
5. docs/01-FEATURES/actividades/walkthrough-activities.md
6. docs/01-FEATURES/actividades/walkthrough-camporees.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/actividades/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/actividades/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/actividades/walkthrough-*.md (si existe)
