# CLAUDE - 01-FEATURES/validacion-investiduras

Guia operativa para el feature validacion-investiduras.

## 1) Alcance

- Dominio: feature
- Feature: validacion-investiduras
- Ruta docs: docs/01-FEATURES/validacion-investiduras/
...
4. docs/01-FEATURES/validacion-investiduras/requirements.md

## 3) Fuente de verdad del feature

- Requisitos funcionales: docs/01-FEATURES/validacion-investiduras/requirements.md (si existe)
- Diseno funcional/tecnico: docs/01-FEATURES/validacion-investiduras/design.md (si existe)
- Walkthroughs: docs/01-FEATURES/validacion-investiduras/walkthrough-*.md (si existe)
